...
<head>
    ...
    <!-- bootstrap -->
    <link href="/first/Application/Admin/View/css/bootstrap/bootstrap.css" rel="stylesheet" />
    <link href="/first/Application/Admin/View/css/bootstrap/bootstrap-responsive.css" rel="stylesheet" />
    <link href="/first/Application/Admin/View/css/bootstrap/bootstrap-overrides.css" type="text/css" rel="stylesheet" />

    <!-- libraries -->
    <link href="/first/Application/Admin/View/css/lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
    <link href="/first/Application/Admin/View/css/lib/font-awesome.css" type="text/css" rel="stylesheet" />

    <!-- global styles -->
    <link rel="stylesheet" type="text/css" href="/first/Application/Admin/View/css/layout.css" />
    <link rel="stylesheet" type="text/css" href="/first/Application/Admin/View/css/elements.css" />
    <link rel="stylesheet" type="text/css" href="/first/Application/Admin/View/css/icons.css" />

    <!-- this page specific styles -->
    <link rel="stylesheet" href="/first/Application/Admin/View/css/compiled/index.css" type="text/css" media="screen" />
...
<body>
                            ...
                            <tbody>
                                ...
                                <tr class="first">
                                    <td>
                                        <input type="checkbox" />
                                        <div class="img">
                                            <img src="/first/Application/Admin/View/img/table-img.png" />
                                        </div>
	...
	<!-- scripts -->
    <script src="/first/Application/Admin/View/js/jquery-latest.js"></script>
    <script src="/first/Application/Admin/View/js/bootstrap.min.js"></script>
    <script src="/first/Application/Admin/View/js/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="/first/Application/Admin/View/js/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="/first/Application/Admin/View/js/jquery.flot.js"></script>
    <script src="/first/Application/Admin/View/js/jquery.flot.stack.js"></script>
    <script src="/first/Application/Admin/View/js/jquery.flot.resize.js"></script>
    <script src="/first/Application/Admin/View/js/theme.js"></script>
