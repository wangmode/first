                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span8 column">
                        <form  id="form" action="<?php echo U('Config/insert');?>" method="post">
                            <div class="field-box">
                                <label>配置标识:</label>
                                <input class="span4 inline-input" type="text" value="<?php echo ($WEB_SITE_TITLE); ?>" name="name"/>
                            </div>
                             <div class="field-box">
                                <label>标题:</label>
                                <input class="span4 inline-input" type="text" name="title"/>
                            </div>
                            <div class="field-box">
                                <label>分组:</label>
                                <div class="ui-select">
                             ...
                             <div class="field-box">
                                <label>排序:</label>
                                <input class="span4 inline-input" type="text" name="sort"/>
                            </div>
